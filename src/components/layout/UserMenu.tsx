...
import { User, Settings, LogOut, Database, Shield, ChevronDown, UserCircle, Globe } from 'lucide-react';
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-56">
        ...
        <DropdownMenuItem asChild>
          <Link to="/wordpress" className="cursor-pointer flex w-full items-center">
